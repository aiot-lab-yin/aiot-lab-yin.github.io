...
<div class="image-wrapper medium">
    <img src="{{ site.baseurl }}/assets/img/2025-mobicom2025-research.png" 
         alt="RF Security Research" 
         class="blog-post-image">
    <div class="image-caption">Our research explores novel approaches to wireless security and device identification</div>
</div>

<!-- ![RF Security Research]({{ site.baseurl }}/assets/img/2025-mobicom2025-research.png)
*Our research explores novel approaches to wireless security and device identification* -->
...
<!-- 
![RF Fingerprinting]({{ site.baseurl }}/assets/img/2025-rf-fingerprinting-diagram.png)
** -->
